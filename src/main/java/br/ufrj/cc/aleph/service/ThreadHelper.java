...
public class ThreadHelper implements Runnable {
	...
	public void run() {
		...
		try {
			...
			String templatePath = StorageHelper.generateTemplate( userRequest.getName(), userRequest.getEmail(), userRequest.getNumFiles(), userRequest.getFolder() );
...
//		String[] cmd = { "/bin/bash", "/home/daniel/pacote/92d4b920096df6a8544c04e4e2ad63ac/script.sh" };
//		
